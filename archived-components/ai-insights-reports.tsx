...
import { Sparkle, TrendUp, TrendDown, Warning, CheckCircle, ChartLine, Users, DeviceMobile, Brain, LightbulbFilament, ArrowUp, ArrowDown, Eye, Plus, X, ListChecks, Clock } from '@phosphor-icons/react'
...
export function AIInsightsReports() {
  ...
  const getCategoryIcon = (category: string) => {
    switch (category) {
      ...
      default: return <Brain className="w-5 h-5" weight="duotone" />
    }
  }

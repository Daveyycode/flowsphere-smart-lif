            ...
            <div className="space-y-6 sm:space-y-8 text-sm sm:text-base">
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed mb-3">
                  By accessing and using FlowSphere ("the Service"), you accept and agree to be
                  bound by the terms and provision of this agreement. If you do not agree to abide
                  by the above, please do not use this service.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  FlowSphere provides a unified platform for smart home management, family safety
                  tracking, and AI-powered automation. Your use of the Service is subject to these
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed mb-3">
                  You agree to immediately notify FlowSphere of any unauthorized use of your
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  Terms of Service or engage in fraudulent, abusive, or illegal activities.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed mb-2">
                  You agree to use FlowSphere only for lawful purposes. You must not:
                </p>
                ...
                <p className="text-muted-foreground leading-relaxed mb-3">
                  You are responsible for ensuring your smart devices are properly secured and
                  configured. FlowSphere is not liable for damages resulting from device
                  malfunctions or security vulnerabilities in third-party devices.
                </p>
                <h3 className="text-base sm:text-lg font-medium mb-2">3.3 Family Tracking</h3>
                <p className="text-muted-foreground leading-relaxed">
                  You must obtain explicit consent from all family members before enabling location
                  tracking features. You agree to use tracking features responsibly and in
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed mb-3">
                  FlowSphere offers Free, Premium ($9.99/month), and Family ($19.99/month)
                  subscription tiers. Pricing is subject to change with 30 days notice to existing
                  subscribers.
                </p>
                ...
                <p className="text-muted-foreground leading-relaxed mb-3">
                  ...
                  FlowSphere to charge your payment method for all subscription fees. Failed
                ...
                <p className="text-muted-foreground leading-relaxed mb-3">
                  ...
                  of the current billing period. We offer a 14-day money-back guarantee for
                  first-time subscribers.
                </p>
                <h3 className="text-base sm:text-lg font-medium mb-2">4.4 Free Trial</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Premium features may be offered with a free trial period. After the trial, your
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed mb-3">
                  We collect data necessary to provide the Service, including device status,
                  location data, and usage analytics. See our Privacy Policy for detailed
                  information about data collection and usage.
                </p>
                <h3 className="text-base sm:text-lg font-medium mb-2">5.2 Data Storage</h3>
                <p className="text-muted-foreground leading-relaxed mb-3">
                  Your data is stored using industry-standard encryption. CCTV footage retention
                  varies by subscription tier: 24 hours (Free), 30 days (Premium), 90 days (Family).
                </p>
                <h3 className="text-base sm:text-lg font-medium mb-2">5.3 Data Ownership</h3>
                <p className="text-muted-foreground leading-relaxed">
                  You retain ownership of your data. Upon account deletion, your personal data will
                  be permanently deleted within 30 days, except where required by law.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed mb-3">
                  ...
                  by FlowSphere and is protected by international copyright, trademark, patent,
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed mb-3">
                  FlowSphere shall not be liable for any indirect, incidental, special,
                  consequential, or punitive damages resulting from your use of the Service,
                  including but not limited to device failures, data loss, security breaches, or
                  unauthorized access.
                </p>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  FlowSphere is not a substitute for emergency services. In case of emergency,
                  always contact local emergency services (911 in the US) directly. Do not rely on
                  FlowSphere notifications for emergency response.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  notified via email or in-app notification 30 days before taking effect. Continued
                  use of the Service after changes constitutes acceptance of new Terms.
                </p>
              </section>

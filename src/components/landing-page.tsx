...
import { Brain, House, Users, Shield, Bell, Clock, Heart, Sparkle } from '@phosphor-icons/react'
        ...
        <header className={cn('flex justify-between items-center', padding, verticalPadding)}>
          ...
          >
            ...
            <div>
              ...
              {!isMobile && (
                <p className={cn('text-muted-foreground', isTablet ? 'text-xs' : 'text-xs')}>
          ...
          <div className="max-w-6xl w-full">
            ...
            >
              <h2
                className={cn(
                  'font-bold text-foreground font-heading',
                  isMobile ? 'text-3xl mb-3' : isTablet ? 'text-4xl mb-3' : 'text-6xl mb-4'
                )}
              >
                FlowSphere
              </h2>
              <p
                className={cn(
                  ...
                  isMobile ? 'text-base mb-2' : isTablet ? 'text-lg mb-2' : 'text-xl mb-3'
                )}
              >
                "Command center for modern life"
              </p>
              <p
                className={cn(
                  ...
                  isMobile ? 'text-sm mb-4' : isTablet ? 'text-base mb-5' : 'text-lg mb-6'
                )}
              >
              ...
              <p
                className={cn(
                  'text-muted-foreground/80 max-w-3xl mx-auto leading-relaxed',
                  isMobile ? 'text-sm px-4' : 'text-base'
                )}
              >
                An AI-driven, privacy-first companion that synchronizes work, family, rest, and home
                into a single daily flow
              </p>
            </motion.div>
            ...
            >
              {features.map((feature, index) => (
                ...
                >
                  <Card
                    className={cn(
                      'h-full flex flex-col items-center text-center hover:shadow-lg transition-shadow bg-card/80 backdrop-blur-sm border-border/50',
                      isMobile ? 'p-4 gap-2' : isTablet ? 'p-5 gap-2' : 'p-6 gap-3'
                    )}
                  >

      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <Button
            onClick={onGetStarted}
            size="lg"
            className="text-base sm:text-lg px-6 sm:px-8 py-5 sm:py-6 bg-primary hover:bg-primary/90 text-primary-foreground font-bold rounded-lg transition-all duration-300 hover:scale-105 shadow-lg"
          >
            Start Free Trial
          </Button>
        </motion.div>

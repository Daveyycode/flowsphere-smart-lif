...
export function ComingSoonSection() {
  ...
  const handleFeatureClick = (feature: ComingSoonFeature) => {
    toast.info(
      `${feature.title}`,
      {
        description: `${feature.description} This feature is coming soon! We're working hard to bring this to you.`,
        duration: 5000
      }
    )
  }
            ...
            {features.map((feature) => {
              ...
              return (
                <motion.button
                  ...
                  className={cn("bg-gray-700/30 backdrop-blur-sm rounded-xl border border-gray-600/40 hover:border-gray-500/50 transition-all cursor-pointer hover:scale-105 active:scale-95 text-left w-full", isMobile ? "p-3" : "p-4")}
                >

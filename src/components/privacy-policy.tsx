        ...
        <CardContent className="p-4 sm:p-6 md:p-8">
          ...
          <div className="p-3 sm:p-4 bg-accent/10 border border-accent/20 rounded-lg mb-6 sm:mb-8">
            <p className="text-xs sm:text-sm text-foreground">
              <strong>Privacy First:</strong> FlowSphere is designed with privacy at its core. Your
              data is encrypted, stored locally when possible, and never sold to third parties.
            </p>
          </div>
            ...
            <div className="space-y-6 sm:space-y-8 text-sm sm:text-base">
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                  <li>
                    <strong>Provide the Service:</strong> Control devices, track family safety, send
                    notifications, and enable automations
                  </li>
                  <li>
                    <strong>AI Features:</strong> Generate personalized insights, morning briefs,
                  ...
                  <li>
                    ...
                    promotional content (opt-out available)
                  </li>
                  <li>
                    <strong>Improvement:</strong> Analyze usage patterns to enhance features and
                    user experience
                  </li>
                  <li>
                    <strong>Support:</strong> Respond to inquiries and troubleshoot issues
                  </li>
                  <li>
                    <strong>Legal Compliance:</strong> Fulfill legal obligations and enforce Terms
                    of Service
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  encryption. End-to-end encryption is used for sensitive communications like family
                  location data.
                </p>

                <h3 className="text-base sm:text-lg font-medium mb-2">3.2 Local-First Storage</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  When possible, data is stored locally on your device using the browser's secure
                  storage. This includes preferences, automation rules, and temporary device states.
                  Only essential data is synced to our servers.
                </p>
                ...
                <ul className="list-disc list-inside space-y-1 text-muted-foreground ml-4 mb-4">
                  ...
                  <li>
                    <strong>CCTV footage:</strong> 24 hours (Free), 30 days (Premium), 90 days
                    (Family)
                  </li>
                  <li>
                    <strong>Location history:</strong> 90 days, then anonymized
                  </li>
                  <li>
                    <strong>Device logs:</strong> 6 months for troubleshooting
                  </li>
                  <li>
                    <strong>Analytics:</strong> 2 years in anonymized form
                  </li>
                </ul>

                <h3 className="text-base sm:text-lg font-medium mb-2">3.4 Access Controls</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Access to user data is strictly limited to authorized personnel who need it to
                  provide support or maintain the Service. All access is logged and monitored.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  FlowSphere does not sell, rent, or trade your personal information to third
                  parties for marketing purposes. Your privacy is not for sale.
                </p>
                ...
                <ul className="list-disc list-inside space-y-1 text-muted-foreground ml-4 mb-4">
                  <li>
                    <strong>Cloud hosting:</strong> AWS (data storage and computing)
                  </li>
                  <li>
                    <strong>Payment processing:</strong> Stripe (payment information only)
                  </li>
                  <li>
                    <strong>Email service:</strong> SendGrid (email addresses for notifications)
                  </li>
                  <li>
                    <strong>Analytics:</strong> Anonymized usage data only
                  </li>
                </ul>
                <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  rights, property, or safety of FlowSphere, our users, or the public.
                </p>

                <h3 className="text-base sm:text-lg font-medium mb-2">4.4 Family Sharing</h3>
                <p className="text-muted-foreground leading-relaxed">
                  In Family plan accounts, the account owner can view location data and device usage
                  of family members who have explicitly consented to sharing.
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4 mb-4">
                  ...
                  <li>
                    <strong>Export:</strong> Download your data in a portable format (JSON/CSV)
                  </li>
                  <li>
                    <strong>Opt-out:</strong> Disable location tracking, analytics, or marketing
                    emails
                  </li>
                  <li>
                    <strong>Restrict:</strong> Limit how we process certain types of data
                  </li>
                  <li>
                    <strong>Object:</strong> Object to data processing for specific purposes
                  </li>
                </ul>
                <p className="text-muted-foreground leading-relaxed">
                  To exercise these rights, visit Settings → Privacy or contact
                  privacy@flowsphere.com.
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-1 text-muted-foreground ml-4 mb-4">
                  <li>
                    <strong>Essential cookies:</strong> Authentication and session management
                    (required)
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Analytics cookies:</strong> Understand how you use the Service (opt-out
                    available)
                  </li>
                </ul>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed mb-3">
                  FlowSphere is not intended for children under 13. We do not knowingly collect
                  personal information from children. If you believe a child has provided us with
                  personal data, please contact us immediately.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  Family tracking features for children 13-17 require parental consent and
                  supervision by the account owner.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed mb-3">
                  FlowSphere operates globally. If you access the Service from outside the United
                  States, your data may be transferred to and stored in the US. We use appropriate
                  safeguards like Standard Contractual Clauses to protect your data.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  For EU users, we comply with GDPR requirements. For California residents, we
                  comply with CCPA.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed mb-3">
                  FlowSphere integrates with third-party smart home devices and services. Their
                  privacy practices are governed by their own privacy policies, which we encourage
                  you to review.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  We are not responsible for the privacy practices of third-party device
              ...
              <section>
                ...
                <div className="p-4 bg-muted/50 rounded-lg">
                  ...
                  <p className="text-muted-foreground mt-2">
                    Data Protection Officer: dpo@flowsphere.com
                  </p>
                </div>
              </section>
              ...
              <div className="pt-6 sm:pt-8 border-t border-border/50">
                <p className="text-xs sm:text-sm text-muted-foreground italic">
                  Your trust is our top priority. We're committed to transparency and protecting
                  your privacy every step of the way.
                </p>
              </div>
            </div>
          </ScrollArea>

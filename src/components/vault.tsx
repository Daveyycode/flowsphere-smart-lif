...
export function Vault({ onNavigate }: VaultProps) {
  const [activeTab, setActiveTab] = useState<
    'passwords' | 'messages' | 'files' | 'notes' | 'settings'
  >('passwords')
  ...
  const [messageExpiry, setMessageExpiry] = useState<'none' | 'view-once' | '1h' | '24h' | '7d'>(
    'none'
  )
  ...
  const handleToggleFavoriteMessage = (id: string) => {
    setMessages(current =>
      (current || []).map(msg => (msg.id === id ? { ...msg, isFavorite: !msg.isFavorite } : msg))
    )
  }
  ...
  const getFileIcon = (type: string) => {
    ...
    if (type.includes('word') || type.includes('document'))
      return <FileDoc className="w-8 h-8 text-blue-500" weight="duotone" />
    if (type.includes('image'))
      return <FileImage className="w-8 h-8 text-green-500" weight="duotone" />
    if (type.includes('zip') || type.includes('compressed'))
      return <FileZip className="w-8 h-8 text-yellow-500" weight="duotone" />
  ...
  const handleTogglePinNote = (id: string) => {
    setNotes(current =>
      (current || []).map(note => (note.id === id ? { ...note, isPinned: !note.isPinned } : note))
    )
  }

  const handleSettingChange = <K extends keyof VaultSettings>(key: K, value: VaultSettings[K]) => {
    setSettings(current => ({
      ...(current || {
        autoLock: true,
        autoLockTimeout: 5,
    ...
    <>
      <div className="space-y-6 pb-8">
        ...
        >
          ...
          <div
            className="h-[calc(90vh-180px)] overflow-y-auto"
            ...
            <div className="px-6 py-4">
              ...
              <TabsContent value="messages" className="mt-0 space-y-4">
                <Card className="border-2 border-primary/20 bg-gradient-to-br from-primary/5 to-accent/5">
                  <CardContent className="py-12 text-center">
                    <ChatCircle
                      className="w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-4 text-primary"
                      weight="duotone"
                    />
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground mb-6 max-w-md mx-auto">
                      End-to-end encrypted messaging with QR code invites. Connect securely with
                      trusted contacts using one-time invite codes.
                    </p>
                    <Button onClick={() => setShowMessenger(true)} size="lg" className="gap-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  <Card>
                    <CardContent className="p-4 text-center">
                      ...
                      <p className="text-xs text-muted-foreground">Secure one-time connections</p>
                    </CardContent>
                  </Card>
                  <Card>
                    <CardContent className="p-4 text-center">
                      ...
                      <p className="text-xs text-muted-foreground">No data leaves your vault</p>
                    </CardContent>
                  </Card>
                </div>
              </TabsContent>
                        ...
                        <Card className="hover:border-primary/50 transition-colors">
                          <CardContent className="p-3 sm:p-4">
                            <div className="flex items-start gap-3">
                              ...
                              <div className="flex-1 min-w-0">
                                <p className="font-medium text-xs sm:text-sm truncate mb-1">
                                  {file.name}
                                </p>
                                <p className="text-xs text-muted-foreground">
                      ...
                      {settings?.autoLock && (
                        <div className="pl-4 border-l-2 border-primary/20">
                          ...
                          <Select
                            ...
                            onValueChange={val =>
                              handleSettingChange('autoLockTimeout', Number(val))
                            }
                          >
                                  ...
                                  try {
                                    ...
                                    if (available) {
                                      ...
                                      toast.success('Biometric unlock enabled', {
                                        description:
                                          'You can now use biometrics to access your files',
                                      })
                                    } else {
                        ...
                        {settings?.biometricUnlock && (
                          <div className="pl-4 border-l-2 border-primary/20 space-y-3">
                            <div className="p-3 bg-primary/5 rounded-lg">
                              ...
                              <p className="text-xs text-muted-foreground">
                                You can use biometrics instead of PIN when downloading encrypted
                                files. PIN remains as backup option.
                              </p>
                            </div>
                      ...
                      <div className="flex items-center justify-between gap-4">
                        ...
                        <Switch
                          ...
                          onCheckedChange={checked =>
                            handleSettingChange('defaultEncryption', checked)
                          }
                        />
                      </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <Button
                        ...
                        onClick={() => {
                          if (
                            confirm(
                              'Are you sure you want to clear all vault data? This cannot be undone.'
                            )
                          ) {
                            setVaultItems([])
                            setMessages([])
                      ...
                      <div className="pt-8 flex justify-center">
                        <button
                          onClick={async () => {
                            // Check if 2FA is already configured
                            const configured =
                              localStorage.getItem('flowsphere_ceo_2fa_configured') === 'true'
      ...
      <Dialog open={showNoteDialog} onOpenChange={setShowNoteDialog}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="note-content" className="text-xs sm:text-sm">
                Content
              </Label>
              <Textarea
                id="note-content"
      ...
      >
        <DialogContent className="sm:max-w-md max-w-[95vw] mx-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="encrypt-pin" className="text-xs sm:text-sm">
      ...
      >
        <DialogContent className="sm:max-w-md max-w-[95vw] mx-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="decrypt-pin" className="text-xs sm:text-sm">
      ...
      {/* CEO Dashboard */}
      {ceoDashboardOpen && <CEODashboard onClose={() => setCEODashboardOpen(false)} />}
          ...
          <div className="space-y-4">
            ...
            <div className="p-3 bg-amber-500/10 border border-amber-500/30 rounded-lg flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  This QR code will only be shown ONCE. After you confirm setup, it will be
                  permanently hidden.
                </p>
              </div>
            </div>
            ...
            <details className="text-xs">
              ...
              <div className="mt-2 p-2 bg-muted rounded-md">
                <code className="text-xs font-mono break-all select-all">{setupTotpSecret}</code>
                <Button
                  variant="ghost"
                  size="sm"
